...
class Applciation(TkinterDnD.Tk):
    def __init__(self):
        super().__init__()
        self.title('H&M')
...
class SearchPage(tk.Frame):
    def __init__(self, parent):
        ...
        self.file_names_listbox.dnd_bind('<<Drop>>', self.drop_inside_list_box) # TODO Binding
        self.file_names_listbox.bind('<Double-1>', self._display_file) # TODO Binding

        self.search_entrybox = tk.Entry(parent)
        self.search_entrybox.place(relx=0.25,relwidth=0.75)
        self.search_entrybox.bind('<Return>', self.search_table) # TODO Binding
    ...
    def drop_inside_list_box(self, event):
        ...
        for file_path in file_paths:
            if file_path.endswith('.csv'):
                # turning file path into an object
                # from that obj can return the name
    ...
    # if index val == space and is not blank
    # we are at the end of the filpath and have to append the name
    ...
    def search_table(self, event):
        # column and value pairs. column=value, column2=value2.....
        # convert into a dictionary, and pass into the find_value
        ...
        if entry == "":
            ...
            for pair in entry_split:
                ...
                if len(pair_split) == 2:
                    ...
                    column_value_pairs[col] = lookup_val
